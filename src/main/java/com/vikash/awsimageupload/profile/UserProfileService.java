...
import com.vikash.awsimageupload.bucket.BucketName;
import com.vikash.awsimageupload.filestore.FileStore;
...
public class UserProfileService {
    ...
    private static void isFileEmpty(MultipartFile file) {
        if(file.isEmpty()) {
            throw new IllegalStateException("Cannot upload emty file");
        }
    }
